...
use App\Buildix\Timex\Pages\Timex;
...
use EvenementResource\Pages\CreateEvenement;
...
class EvenementResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Select::make('statut')
                ->options([
                    StatesClass::Activated()->value=>'Validée',
                    StatesClass::Deactivated()->value=>'Rejetée',
                    StatesClass::Suspended()->value=>'En attente de validation'
                ])
                    ->hidden(!auth()->user()->hasRole(RolesPermissionSeeder::Secretaire))
                    ->hiddenOn(Timex::class)
                    ->columnSpanFull(),
                ...
                Select::make('salle_id')
                        ->label('Salle')
                        ->options(Salle::Select(["nom","id"])->pluck('nom','id'))
                        ->columnSpanFull()
                        ->required(),
    ...
    {
        return [
            'index' => EvenementResource\Pages\ListEvenements::route('/'),
            'create' =>EvenementResource\Pages\CreateEvenement::route('/create'),
            'edit' => EvenementResource\Pages\EditEvenement::route('/{record}/edit'),
        ];
    }
