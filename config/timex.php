...
return [
    ...
    */
    ...
    'pages' => [
        'timex' => \App\Buildix\Timex\Pages\Timex::class,
        'slug' => 'timex',
        'group' => 'Agenda',
        'sort' => 0,
    ...
    'resources' => [
        'event' => \App\Filament\Resources\EvenementResource::class, 
        'sort' => 1,
    ...
    'models' => [
        'event' => \App\Models\Evenement::class,
        'users' => [
    ...
    */
        ...
        */
            'labels' => [
                ...
                'primary' => StatesClass::pending()->value,
                'secondary' => StatesClass::Rejected()->value,
                'danger' => StatesClass::ValidateByDirector()->value,
                'success' => StatesClass::Validated()->value,

            ],
            'icons' => [
                'primary' => 'heroicon-o-chat-alt',
                'secondary' => 'heroicon-o-x',
